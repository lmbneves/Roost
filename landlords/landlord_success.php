    ...
    <div class="container">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <p>You have successfully added a new landlord!</p>

          <input type="submit" class="btn btn-default" value="Return to Home" onclick="window.location='http://www.uroost.org/index.php';" />
